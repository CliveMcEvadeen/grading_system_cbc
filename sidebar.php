...
<!-- insert the school image -->


 <ul class="nav navbar-nav side-nav">
    <li><img src="logo.png" alt="school budge"></li>
 <li>
...
<li>
    ...
    <ul>
        <li>
            <a href="rms.php?page=sheet"><i class="fa fa-file-excel-o"></i> Import Sheet</a>
        </li>
    </ul>
    <ul>
        <li>
            <a href="rms.php?page=sheet2"><i class="fa fa-file-excel-o"></i> Generate Sheet</a>
        </li>
    </ul>

</li>
<!-- the target pages must be changed to point to the designated page -->
<!-- the last xxl sheets must be added to the sidebar -->
</ul>
<script>
